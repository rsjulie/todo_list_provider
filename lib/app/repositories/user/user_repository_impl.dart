    ...
    try {
      ...
      if (googleUser != null) {
        ...
        if (loginMethods.contains('password')) {
          throw AuthException(
              message:
                  'Você utilizou o e-mail para cadastro no app. Caso você tenha esquecido sua senha, por favor clique no link "esqueci minha senha"');
        } else {
      ...
      if (e.code == 'account-exists-with-different-credential') {
        throw AuthException(
            message:
                '''Login inválido. Vocẽ se registrou com os seguintes provedores:
                ${loginMethods?.join(',')}
                ''');
      } else {
